...
class FibonacciConsumer implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                // Mostramos el elemento por pantalla y el número de elementos en la cola
                System.out.println("Consumer: consumed element " + element + ", queue size = " + queue.size());
            } catch (InterruptedException e) {
                // Si se produce una excepción InterruptedException, salimos del bucle
                break;
            }
    ...
    public class Main {
        public static void main(String[] args) {
            // Creamos una LinkedBlockingQueue de tamaño 10 como cola bloqueante
